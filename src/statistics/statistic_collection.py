...
class StatisticCollection(object):
    ...
    def get_heatmap_collection(number_of_magnets, dimensions, polatizations, radius):
        ...
        df = pd.DataFrame(B_amplitudes, 
                          columns=['number_of_magnets', 
                                   'polarization', 
                                   'dimension', 
                                   'B_amplitude'])

        number_of_magnets_polarization = 'statistics/heatmaps/number_of_magnets_polarization'
        ...
        for dim in df['dimension'].unique():
            ...
            plt.savefig(f'{number_of_magnets_polarization}/heatmap_dimension_{dim}m.png')
            plt.close()
...
if __name__ == "__main__":
    ...
    StatisticCollection.get_heatmap_collection(number_of_magnets, 
                                               dimensions, 
                                               polatizations, 
                                               radius)